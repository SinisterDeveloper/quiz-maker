				...
				switch (s) {
					...
					case `object`:
						switch (e.$$typeof) {
							...
							case d:
								return (
									(c = e._init), ce(c(e._payload), r, i, a, o)
								);
						}
				}
			if (c)
...
` +
		...
		function Fr(e, t) {
			return (
				e && t ?
					e === t ? !0
					: e && e.nodeType === 3 ? !1
					: t && t.nodeType === 3 ? Fr(e, t.parentNode)
		...
		function Wa(e) {
			...
			function l(e, t, n, r) {
				var a = n.type;
				return (
					a === y ? d(e, t, n.props.children, r, n.key)
					: (
						t !== null &&
						(t.elementType === a ||
							(typeof a == `object` &&
		...
		var Ws = {
				...
				useCallback: function (e, t) {
					return (
						(Fo().memoizedState = [e, t === void 0 ? null : t]), e
					);
				},
				useContext: la,
				useEffect: ms,
		...
		function oc(e, t, n, r, i) {
			...
			if (j)
				return (
					...
					t === null ?
						(r !== Gi &&
							((t = Error(s(423), { cause: r })), Qi(Di(t, n))),
					...
					:	(!(t.flags & 65536) && (t.flags |= 256),
						...
						(t.lanes = i),
						r !== Gi &&
							((e = Error(s(422), { cause: r })), Qi(Di(e, n)))),
					!1
				);
		...
		function _c(e, t, n) {
			...
			if (((t.flags &= -129), e === null)) {
				if (j) {
					if (r.mode === `hidden`)
						return (
							(e = hc(t, r)), (t.lanes = 536870912), pc(null, e)
						);
					if (
						(mo(t),
						(e = A) ?
				...
				case 27:
					return (
						...
						e === null &&
							j &&
							((r = t.stateNode =
								ff(t.type, t.pendingProps, ge.current)),
							(Hi = t),
							(Wi = !0),
							(i = A),
							Zd(t.type) ?
								((lf = i), (A = cf(r.firstChild)))
							:	(A = i)),
			...
			switch ((Bi(t), t.tag)) {
				...
				case 27:
					if (
						...
						(e = me.current),
							Yi(t) ?
								qi(t, e)
							:	((e = ff(i, r, n)), (t.stateNode = e), Lc(t));
					}
					return B(t), null;
				case 5:
					if (
						(xe(t), (i = t.type), e !== null && t.stateNode != null)
					)
						e.memoizedProps !== r && Lc(t);
					else {
						if (!r) {
				...
				case 13:
					if (
						...
						if (
							((i = Yi(t)), r !== null && r.dehydrated !== null)
						) {
							if (e === null) {
				...
				case 19:
					if ((O(N), (r = t.memoizedState), r === null))
						return B(t), null;
					if (
						((i = (t.flags & 128) != 0),
						(a = r.rendering),
		...
		function tl(e, t, n) {
			...
			if (r === 5 || r === 6)
				(e = e.stateNode),
					t ?
						(n.nodeType === 9 ? n.body
						: n.nodeName === `HTML` ? n.ownerDocument.body
						: n
						).insertBefore(e, t)
					:	((t =
							n.nodeType === 9 ? n.body
				...
				case 6:
					if (
						...
						if (ul)
							try {
								(U.nodeType === 9 ? U.body
								: U.nodeName === `HTML` ? U.ownerDocument.body
								: U
				...
				case 22:
					...
					if (
						...
						a: for (
							t = e.stateNode,
								t._visibility =
									i ? t._visibility & -2 : t._visibility | 1,
		...
		function fd(e) {
			return (
				e == null || typeof e == `symbol` || typeof e == `boolean` ?
					null
				: typeof e == `function` ? e
				: cn(`` + e)
			);
		...
		function Cd(e, t, n, r) {
			...
			(n = i.bind(null, t, n, e)),
				...
				: i === void 0 ? e.addEventListener(t, n, !1)
				...
				if (!(t & 7)) {
					...
					x &&
						(ir &&
							...
							:	((xn = i),
								(Sn =
									`value` in xn ? xn.value : xn.textContent),
								(lr = !0))),
						(y = Ed(r, x)),
						0 < y.length &&
...
`,
		...
		function Dp(e) {
			...
			for (var t = e.targetContainers; 0 < t.length; ) {
				...
				if (n === null) {
					...
					return (
						(t = Tt(n)), t !== null && ap(t), (e.blockedOn = n), !1
					);
				t.shift();
			}
			return !0;
	...
	_ = (e) => e.trim().toUpperCase();
function v() {
	let [e, t] = (0, f.useState)(``),
		[n, r] = (0, f.useState)(``),
		[i, a] = (0, f.useState)(``),
		[o, s] = (0, f.useState)(`dashboard`),
		[c, l] = (0, f.useState)([]),
		[u, d] = (0, f.useState)([]),
		[_, v] = (0, f.useState)(``),
		[y, b] = (0, f.useState)([]),
		...
		[ie, ae] = (0, f.useState)(``),
		[oe, se] = (0, f.useState)(``),
		[ce, le] = (0, f.useState)(!1),
		[ue, T] = (0, f.useState)(null),
		[E, de] = (0, f.useState)({
			name: ``,
			timer: ``,
			conclusion: ``,
		...
		pe = (0, f.useMemo)(() => g(c, 6), [c]),
		O = (0, f.useMemo)(() => g(u, 6), [u]),
		k = (0, f.useMemo)(() => g(y, 15), [y]),
		me = async (e = i) => {
			if (!e) return;
			let t = await h(`/admin/deck`, {
				headers: { Authorization: `Bearer ${e}` },
			});
			if (!t.ok) return;
			let n = await t.json();
			l(Array.isArray(n) ? n : []), ne(0);
		},
		he = async (e = i) => {
			if (!e) return;
			let t = await h(`/admin/result`, {
				headers: { Authorization: `Bearer ${e}` },
			});
			if (!t.ok) return;
			let n = await t.json();
			d(Array.isArray(n) ? n : []), w(0);
		},
		ge = async (t) => {
			t.preventDefault(), r(``);
			let n = await h(`/admin/login`, { headers: { Authorization: e } });
			if (!n.ok) {
				r(`Invalid Password`);
				return;
			}
			let i = await n.json();
			a(i.token), await Promise.all([me(i.token), he(i.token)]);
		},
		_e = (e) => {
			s(e), ae(``), se(``);
		},
		ve = (e) => (e?.questions ? Object.values(e.questions) : []),
		ye = async (e) => {
			window.confirm(
				`This will delete the Deck "${e.name}" and all of it's questions and results. This action cannot be undone.`,
			) &&
				(await h(`/admin/deck`, {
					method: `DELETE`,
					body: JSON.stringify({ type: `deck`, value: e.id }),
					headers: {
						'Content-type': `application/json; charset=UTF-8`,
						Authorization: `Bearer ${i}`,
					},
				}),
				await h(`/admin/result`, {
					method: `PUT`,
				...
				await Promise.all([me(), he()]));
		},
		be = async (e) => {
			let t = `${m}/quiz?deck=${e.id}`;
			try {
				if (navigator.share) {
					await navigator.share({ url: t });
					return;
				}
				throw Error(`Share API unavailable`);
			} catch {
				window.alert(
		...
		xe = (e) => {
			...
			b(t), ee(0), s(`viewquestions-option`);
		},
		Se = async (e, t) => {
			window.confirm(
				`Are you sure you want to delete this question? This action cannot be undone.`,
			) &&
				(await h(`/admin/question`, {
					method: `DELETE`,
					body: JSON.stringify({ question: e, deck: t }),
					headers: {
						'Content-type': `application/json; charset=UTF-8`,
						Authorization: `Bearer ${i}`,
					},
		...
		Ce = async (e) => {
				...
				await h(`/admin/deck`, {
					...
					body: JSON.stringify({
						data: {
							...
							timer: E.timer.trim(),
							email: E.email === `Yes` ? `Yes` : ``,
							shuffle: E.shuffle === `Yes` ? `Yes` : ``,
						},
					}),
					headers: {
						'Content-type': `application/json; charset=UTF-8`,
			...
			if (!t.success) {
				ae(`Error: ${t.errorMessage}`);
				return;
			}
			if (ue) {
				let e = new FormData();
				e.append(`image`, ue),
					await h(`/admin/deck?deck=${t.deck}`, {
						method: `PUT`,
						body: e,
						headers: { Authorization: `Bearer ${i}` },
					});
			}
			ae(`Deck successfully created!`),
				de({
					name: ``,
					timer: ``,
					conclusion: ``,
		...
		we = async () => {
			...
			le(!0);
			let e = await h(`/admin/ai`, {
				method: `POST`,
				body: JSON.stringify({ question: D.question }),
				headers: {
					'Content-type': `application/json; charset=UTF-8`,
					Authorization: `Bearer ${i}`,
				},
			...
			if (!e.ok) {
				...
				let t = await e.text();
				window.alert(`Error: ${t}`), le(!1);
				return;
			}
			let t = await e.json();
			fe((e) => ({
				...e,
				option1: t[0] || e.option1,
				option2: t[1] || e.option2,
				option3: t[2] || e.option3,
				option4: t[3] || e.option4,
			})),
				le(!1);
		},
		Te = async (e) => {
			if ((e.preventDefault(), se(``), !_)) {
				se(
					`Error: Pick a deck from Add Question before creating a question`,
				);
				return;
			}
			if (!D.answer) {
				se(`Error: Choose the correct answer option`);
				return;
			}
			let t = await (
				await h(`/admin/question`, {
			...
			if (!t.success) {
				se(`Error: ${t.errorMessage}`);
				return;
			}
			se(`Question successfully created!`),
				fe({
					question: ``,
					option1: ``,
					option2: ``,
		...
		Ee = async (e) => {
			window.confirm(`This action cannot be undone.`) &&
				(await h(`/admin/result`, {
					method: `DELETE`,
					body: JSON.stringify({ type: `result`, value: e.id }),
					headers: {
						'Content-type': `application/json; charset=UTF-8`,
						Authorization: `Bearer ${i}`,
					},
	...
	if (!i)
		return (0, p.jsx)(`div`, {
			className: `min-h-screen flex items-center justify-center text-white bg-gray-950`,
			id: `login-page`,
			children: (0, p.jsxs)(`form`, {
				className: `place-content-center text-3xl`,
				onSubmit: ge,
				id: `loginForm`,
				children: [
					(0, p.jsxs)(`label`, {
	...
	let De = pe[te] || [],
		...
		ke = k[x] || [];
	return (0, p.jsxs)(`div`, {
		className: `flex h-screen text-white bg-zinc-900`,
		id: `dashboard-page`,
		children: [
			(0, p.jsxs)(`div`, {
				className: `w-64 bg-gray-950 p-4 flex flex-col`,
				children: [
					(0, p.jsx)(`div`, {
							...
							children: [
								...
								(0, p.jsxs)(
									`p`,
									{
										id: `sidebar-${e.id}`,
										onClick: () => _e(e.id),
										className: `flex items-center p-2 hover:bg-zinc-700 rounded sidebar-item cursor-pointer ${o === e.id ? `text-yellow-400` : ``}`,
										children: [
											(0, p.jsx)(`img`, {
												src: e.image,
												alt: e.label,
			...
			(0, p.jsxs)(`div`, {
				className: `flex-grow p-4 flex-1 flex`,
				children: [
					(0, p.jsxs)(`div`, {
						className: `webpage bg-zinc-900 p-6 rounded-lg shadow-lg max-w-screen flex-grow ${o === `addquestion-option` ? `block` : `hidden`}`,
						...
						children: [
							...
							:	(0, p.jsx)(`p`, {
									...
									children: `Open a deck and click "Add Question" first.`,
								}),
							(0, p.jsxs)(`form`, {
								className: `space-y-4`,
								onSubmit: Te,
								children: [
									...
									(0, p.jsx)(`div`, {
										...
										children: (0, p.jsx)(`button`, {
											type: `button`,
											onClick: we,
											className: `mt-1 p-2 bg-zinc-700 rounded text-blue-400 ${ce ? `animate-pulse` : ``}`,
											children: `Autofill Choices`,
										}),
									}),
									[
										`option1`,
												...
												children: [
													...
													(0, p.jsxs)(
														`button`,
														{
															...
															className: `option-buttons w-32 h-10 flex items-center justify-center border rounded bg-zinc-700 mt-4 ${D.answer === e ? `text-green-500 chosen-Answer` : `text-white`}`,
															children: [
																`Option `,
																t + 1,
															],
									...
									(0, p.jsxs)(`div`, {
										...
										children: [
											...
											(0, p.jsx)(`button`, {
												type: `submit`,
												className: `mt-4 p-2 bg-zinc-700 rounded ml-4 text-green-400`,
												children: `Add`,
											}),
										],
									}),
									oe ?
										(0, p.jsx)(`div`, {
											...
											children: (0, p.jsx)(`p`, {
												className: `mt-4 p-2 bg-zinc-700 rounded ${oe.startsWith(`Error:`) ? `text-red-400` : `text-green-400`}`,
												children: oe,
											}),
										})
									:	null,
					...
					(0, p.jsxs)(`div`, {
						className: `webpage bg-zinc-900 p-6 rounded-lg shadow-lg max-w-screen flex-grow ${o === `adddisplay-option` ? `block` : `hidden`}`,
						id: `adddisplay-option`,
						children: [
							(0, p.jsx)(`h1`, {
								className: `text-xl font-bold mb-4`,
								children: `Question Viewer`,
							}),
							S ?
								(0, p.jsxs)(`div`, {
									className: `space-y-4`,
														...
														(e, t) =>
															(0, p.jsxs)(
																`button`,
																{
																	...
																	disabled:
																		!0,
																	className: `option-buttons w-32 h-10 flex items-center justify-center border rounded bg-zinc-700 mt-4 ${e === S.answer ? `text-green-500 chosen-Answer` : `text-white`}`,
																	children: [
																		`Option `,
																		t + 1,
																	],
					...
					(0, p.jsxs)(`div`, {
						className: `webpage rounded-lg shadow-lg max-w-screen flex-grow ${o === `viewquestions-option` ? `block` : `hidden`}`,
					...
					(0, p.jsxs)(`div`, {
						className: `webpage rounded-lg shadow-lg max-w-screen inset-0 ${o === `help-container` ? `block` : `hidden`}`,
						id: `help-container`,
						children: [
							(0, p.jsxs)(`p`, {
								className: `mb-2`,
								children: [
									...
									(0, p.jsx)(`a`, {
										...
										target: `_blank`,
										rel: `noreferrer`,
										href: `https://github.com/SinisterDeveloper/quiz-maker/wiki#Documentation`,
										children: `here`,
									}),
								],
							}),
							...
							(0, p.jsx)(`h2`, {
								...
								children: `Quiz Background Image`,
							}),
							(0, p.jsxs)(`p`, {
								className: `my-4`,
								children: [
									`The server directly saves the uploaded image `,
									(0, p.jsx)(`em`, {
										children: `without modification (resizing, compression, etc.)`,
									}),
									` to its storage and serves the image file as is to the quiz page.`,
								],
							}),
							(0, p.jsx)(`h1`, {
								className: `text-2xl font-bold my-4`,
							...
							(0, p.jsxs)(`p`, {
								children: [
									`You may email me (`,
									(0, p.jsx)(`code`, {
										className: `font-mono bg-gray-700 p-1 rounded`,
										children: `thesinisterdev@gmail.com`,
									}),
									`) or`,
									` `,
									(0, p.jsx)(`em`, {
										children: (0, p.jsx)(`a`, {
											...
											target: `_blank`,
											rel: `noreferrer`,
											href: `https://github.com/SinisterDeveloper/quiz-maker/issues`,
					...
					(0, p.jsxs)(`div`, {
						className: `webpage bg-zinc-900 p-6 rounded-lg shadow-lg max-w-screen flex-grow ${o === `adddeck-option` ? `block` : `hidden`}`,
						id: `adddeck-option`,
						children: [
							(0, p.jsx)(`h1`, {
								className: `text-xl font-bold mb-4`,
								...
								children: [
													...
													(e) =>
														(0, p.jsx)(
															`button`,
															{
																...
																className: `option-buttons w-32 h-10 flex items-center justify-center border rounded bg-zinc-700 text-white mt-4 ${E.email === e ? `chosen-Email text-green-500` : ``}`,
																children: e,
															},
															e,
														),
													...
													(e) =>
														(0, p.jsx)(
															`button`,
															{
																...
																className: `option-buttons w-32 h-10 flex items-center justify-center border rounded bg-zinc-700 text-white mt-4 ${E.shuffle === e ? `chosen-Shuffle text-green-500` : ``}`,
																children: e,
															},
															e,
														),
									...
									(0, p.jsxs)(`div`, {
										...
										children: [
											(0, p.jsx)(`label`, {
												className: `w-1/3 text-blue-200`,
												children: `Quiz Background Image (Optional, BETA)`,
											}),
											(0, p.jsx)(`div`, {
												className: `flex space-x-2`,
												children: (0, p.jsxs)(`label`, {
													className: `option-buttons w-20 h-10 flex items-center justify-center border rounded bg-zinc-700 text-zinc-100 mt-4 cursor-pointer`,
													children: [
														ue ? `Uploaded` : (
															`Upload`
														),
									...
									ie ?
										(0, p.jsx)(`div`, {
											className: `flex justify-center mt-2`,
											children: (0, p.jsx)(`p`, {
												className: `mt-4 p-2 bg-zinc-700 rounded ${ie.startsWith(`Error:`) ? `text-red-400` : `text-green-400`}`,
												children: ie,
											}),
										})
									:	null,
					...
					(0, p.jsxs)(`div`, {
						className: `webpage rounded-lg shadow-lg max-w-screen flex-grow ${o === `deck-container` ? `block` : `hidden`}`,
						id: `deck-container`,
						children: [
							(0, p.jsxs)(`div`, {
							...
							(0, p.jsx)(`div`, {
								...
								children: De.map((e) => {
									...
									return (0, p.jsxs)(
										`div`,
										{
											className: `bg-zinc-800 text-white p-4 rounded-lg relative deck-container`,
											children: [
												(0, p.jsxs)(`p`, {
													className: `absolute top-2 right-2 bg-zinc-700 px-2 py-1 rounded`,
													children: [`#`, e.id],
												}),
												(0, p.jsx)(`div`, {
													className: `flex justify-between items-center mb-4`,
													children: (0, p.jsx)(`p`, {
														className: `text-lg font-semibold text-blue-300 w-full`,
														children: e.name,
													}),
												}),
												(0, p.jsxs)(`div`, {
					...
					(0, p.jsxs)(`div`, {
						className: `webpage rounded-lg shadow-lg max-w-screen flex-grow ${o === `result-container` ? `block` : `hidden`}`,
						id: `result-container`,
						children: [
							(0, p.jsxs)(`div`, {
										...
										`div`,
										{
											...
											children: [
												...
												(0, p.jsxs)(`div`, {
													...
													children: [
														(0, p.jsxs)(`p`, {
															className: `px-2 py-1 rounded w-full mb-2`,
															children: [
																`Name: `,
																e.name,
															],
												...
												(0, p.jsxs)(`div`, {
													...
													children: [
														(0, p.jsx)(`button`, {
															className: `result-option-button bg-zinc-700 p-3 rounded-lg w-full hover:bg-gray-900 text-blue-200`,
															onClick: () =>
																window.open(
																	`/result?player=${e.id}`,
																),
															children: `View Detailed Result`,
														}),
														(0, p.jsx)(`button`, {
															className: `result-option-button bg-zinc-700 p-3 rounded-lg w-full hover:bg-gray-900 text-blue-200`,
															onClick: () =>
					...
					(0, p.jsxs)(`div`, {
						className: `webpage flex flex-col rounded-lg shadow-lg max-w-screen flex-grow items-center justify-center select-none ${o === `dashboard` ? `flex` : `hidden`}`,
						id: `dashboard`,
						children: [
							(0, p.jsxs)(`div`, {
								...
								children: [
									(0, p.jsx)(`a`, {
										href: `https://github.com/SinisterDeveloper/quiz-maker?tab=readme-ov-file#setup-and-configuration`,
										target: `_blank`,
										rel: `noreferrer`,
										className: `bg-zinc-700 text-white py-2 px-4 rounded-md text-sm`,
										children: `Watch Demo`,
									}),
									(0, p.jsx)(`a`, {
										href: `https://github.com/SinisterDeveloper/quiz-maker/wiki`,
										target: `_blank`,
										rel: `noreferrer`,
										className: `bg-zinc-700 text-white py-2 px-4 rounded-md text-sm`,
										children: `Guide`,
									...
									(0, p.jsx)(`a`, {
										href: `https://github.com/SinisterDeveloper/quiz-maker`,
										target: `_blank`,
										rel: `noreferrer`,
										className: `bg-zinc-700 text-white py-2 px-4 rounded-md text-sm`,
							...
							(0, p.jsx)(`h1`, {
								className: `text-center text-7xl font-bold my-8`,
								children: `Quiz-Maker`,
							}),
							(0, p.jsx)(`p`, {
								className: `text-center text-lg mb-8`,
								children: `Lightweight, AI-enhanced platform for effortless quiz creation and sharing with lightning-fast performance`,
							}),
							(0, p.jsxs)(`div`, {
								className: `flex space-x-2`,
								children: [
									(0, p.jsx)(`img`, {
										...
										src: `https://img.shields.io/github/package-json/v/SinisterDeveloper/quiz-maker?style=plastic&label=Version&logo=github`,
									}),
									(0, p.jsx)(`img`, {
										alt: `CodeFactor Grade`,
										src: `https://img.shields.io/codefactor/grade/github/SinisterDeveloper/quiz-maker?style=plastic&logo=codefactor`,
									}),
									(0, p.jsx)(`img`, {
										alt: `GitHub Issues`,
										src: `https://img.shields.io/github/issues/SinisterDeveloper/quiz-maker?style=plastic&logo=github&label=Issues&color=blue`,
									}),
									(0, p.jsx)(`img`, {
										alt: `GitHub License`,
										src: `https://img.shields.io/github/license/SinisterDeveloper/quiz-maker?style=plastic&logo=github&color=blue`,
									}),
								],
							}),
						],
...
function y() {
	let [e, t] = (0, f.useState)(``),
		...
		[ee, S] = (0, f.useState)(``),
		[C, te] = (0, f.useState)(!1),
		[ne, re] = (0, f.useState)(0);
	(0, f.useEffect)(() => {
		let e = new URL(window.location.href).searchParams.get(`deck`);
		if (!e) {
		...
		(0, f.useEffect)(() => {
			...
			let t = !0;
			return (
				h(`/quiz/metadata?deck=${e}`)
					.then((e) => (e.ok ? e.json() : null))
					.then((e) => {
						!e || !t || (r(e), (document.title = e.name));
					}),
				() => {
					t = !1;
				}
		...
		(0, f.useEffect)(() => {
			if (!o?.timer) return;
			let e = Date.now() + o.timer * 60 * 1e3;
			re(e - Date.now());
			let t = window.setInterval(() => {
					re(Math.max(e - Date.now(), 0));
				}, 1e3),
				n = window.setTimeout(
					() => {
						w();
			...
			return () => {
				window.clearInterval(t), window.clearTimeout(n);
			};
		}, [o]),
		(0, f.useEffect)(() => {
			if (!i) return;
			...
			h(`/quiz/questions?question=${e.id}`, {
				headers: { Authorization: `Bearer ${i}` },
			})
				.then((e) => (e.ok ? e.json() : ``))
				.then((e) => {
	...
	let w = async () => {
			if (!(!i || !e)) {
				...
				window.location.assign(`/result?player=${i}`);
			}
		},
		ie = async (t) => {
			...
			let i = await (
				await h(`/quiz/questions`, {
					headers: { Authorization: `Bearer ${r.token}` },
				})
			).json();
			y(Array.isArray(i) ? i : []), x(0), g(!0);
		},
		ae = v[b],
		oe = Math.floor((ne % (1e3 * 60 * 60)) / (1e3 * 60)),
		se = Math.floor((ne % (1e3 * 60)) / 1e3),
		ce =
			n?.background === `custom` && e ?
				{
					backgroundImage: `url(/img/BG_${e}.jpeg)`,
		...
		le = async (e) => {
			!i ||
				...
				(await h(`/quiz/questions`, {
					method: `PUT`,
					body: JSON.stringify({ id: ae.id, option: e }),
					headers: {
						'Content-type': `application/json; charset=UTF-8`,
						Authorization: `Bearer ${i}`,
					},
	...
	return (0, p.jsxs)(p.Fragment, {
		children: [
			(0, p.jsx)(`div`, {
				id: `details`,
				className: `min-h-screen flex items-center justify-center ${n?.background === `custom` ? `` : `bg-gray-950`}`,
				style: ce,
					...
					children:
						...
						:	(0, p.jsxs)(`form`, {
								...
								children: [
									...
									:	null,
									(0, p.jsx)(`button`, {
										className: `w-full rounded-lg p-2 text-blue-300`,
										type: `submit`,
										children: `Submit`,
									}),
								],
			...
			(0, p.jsx)(`div`, {
				className: `min-h-screen flex items-center justify-center question-container place-content-center ${n?.background === `custom` ? `` : `bg-gray-950`}`,
				id: `container`,
				style: { ...ce, display: m ? `flex` : `none` },
				children:
					C ?
						(0, p.jsxs)(`div`, {
							className: `bg-zinc-900 text-white p-8 rounded-lg shadow-lg w-full max-w-md opacity-75`,
							id: `instructions`,
							children: [
								(0, p.jsx)(`h1`, {
								...
								(0, p.jsxs)(`ul`, {
									...
									children: [
										(0, p.jsx)(`li`, {
											children: (0, p.jsx)(`h3`, {
												className: `text-lg`,
												children: `Each question is in multiple-choice format with four options. Click on an option to save your answer.`,
											}),
										}),
										(0, p.jsx)(`li`, {
											children: (0, p.jsxs)(`h3`, {
												className: `text-lg`,
												children: [
													`To reset a saved answer, click the `,
													(0, p.jsx)(`code`, {
														className: `font-mono bg-gray-700 p-1 rounded`,
														children: `Clear`,
													}),
								...
								(0, p.jsx)(`div`, {
									...
									children: (0, p.jsx)(`button`, {
										id: `instruction-ok`,
										className: `bg-gray-700 px-4 py-2 font-semibold rounded-lg shadow-md`,
										onClick: () => te(!1),
										children: `Ok`,
									}),
								}),
					...
					:	(0, p.jsxs)(`div`, {
							...
							children: [
								(0, p.jsx)(`button`, {
									className: `bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded absolute top-4 right-4`,
									id: `submit`,
									onClick: () => {
										window.confirm(
								...
								(0, p.jsx)(`button`, {
									className: `bg-green-500 hover:bg-green-600 px-4 py-2 rounded absolute top-4 left-4`,
								...
								(0, p.jsx)(`h2`, {
									...
									id: `quiz-name`,
									children: n?.name || `QUIZ NAME`,
								}),
								(0, p.jsx)(`hr`, {
									className: `border-t border-zinc-500 mb-4`,
								}),
								(0, p.jsx)(`p`, {
									className: `text-center text-lg font-bold mb-4`,
									id: `question`,
									children: ae?.question || `QUESTION TEXT`,
								}),
								(0, p.jsx)(`div`, {
									className: `space-y-4 answer-buttons`,
									id: `options`,
									children: ae?.options?.map((e) =>
										(0, p.jsx)(
											`button`,
											{
												className: `bg-zinc-800 text-white p-2 rounded w-full answer-button ${ee === e ? `chosen-answer` : ``}`,
												onClick: () => le(e),
												children: e,
											},
											e,
								...
								(0, p.jsx)(`hr`, {
									className: `border-t border-zinc-500 mt-4 mb-2`,
								}),
								(0, p.jsxs)(`div`, {
...
function b() {
	let [e, t] = (0, f.useState)(null),
		...
		[i, a] = (0, f.useState)(!1);
	(0, f.useEffect)(() => {
		let e = new URL(window.location.href).searchParams.get(`player`);
		e &&
			h(`/quiz/result?player=${e}`)
				.then((e) => (e.ok ? e.json() : null))
				.then((e) => {
					e?.stats &&
						(t(e.stats),
						r(Array.isArray(e.answers) ? e.answers : []));
				});
	}, []);
	let o = (0, f.useMemo)(() => {
		if (!e) return `Loading...`;
		let t = e.timeEnded - e.timeStarted,
			n = Math.trunc(t / 6e4);
		return `${n} minutes, ${Math.trunc(t / 1e3 - 60 * n)} seconds`;
	}, [e]);
	return (0, p.jsx)(`div`, {
		...
		children:
			i ?
				(0, p.jsx)(`div`, {
					className: `webpage flex justify-center items-center relative text-white`,
					id: `performance-page`,
					children: (0, p.jsxs)(`div`, {
						...
						children: [
							(0, p.jsx)(`h1`, {
								className: `text-3xl`,
								children: `Question-Wise Performance:`,
							}),
							(0, p.jsx)(`br`, {}),
							(0, p.jsx)(`button`, {
								className: `bg-zinc-700 p-3 rounded-lg hover:bg-gray-950 text-blue-200 mb-3 absolute left-1 top-1`,
								onClick: () => a(!1),
								children: `Back`,
							}),
							(0, p.jsx)(`hr`, {}),
							(0, p.jsxs)(`table`, {
								className: `border-separate border-spacing-2 w-full border border-gray-500 bg-slate-900 text-sm shadow-sm`,
								children: [
									(0, p.jsx)(`thead`, {
										...
										children: (0, p.jsxs)(`tr`, {
											children: [
												(0, p.jsx)(`th`, {
													className: `w-1/4 border border-gray-600 font-semibold p-4 text-gray-200`,
													children: `Question`,
												}),
												(0, p.jsx)(`th`, {
													className: `w-1/4 border border-gray-600 font-semibold p-4 text-gray-200`,
										...
										children: n.map((e, t) =>
											(0, p.jsxs)(
												`tr`,
												{
													children: [
														(0, p.jsx)(`td`, {
															className: `w-1/4 border border-gray-600 p-4 text-gray-200`,
															children:
																e.question,
														}),
														(0, p.jsx)(`td`, {
			...
			:	(0, p.jsx)(`div`, {
					...
					children: (0, p.jsxs)(`div`, {
						...
						children: [
								...
								children: (0, p.jsxs)(`tbody`, {
									children: [
										(0, p.jsxs)(`tr`, {
											children: [
												(0, p.jsx)(`th`, {
													className: `bg-gray-700 w-1/6 border border-gray-600 font-semibold p-4 text-gray-200`,
													children: `Name`,
												}),
												(0, p.jsx)(`td`, {
													className: `w-1/2 border border-gray-600 p-4 text-gray-200`,
													id: `name`,
													children:
														e?.name || `Loading...`,
												}),
							...
							(0, p.jsx)(`button`, {
								className: `bg-zinc-700 p-3 rounded-lg hover:bg-gray-950 text-blue-200 absolute top-1 right-1`,
								onClick: () => a(!0),
								children: `Question-wise Performance`,
							}),
							(0, p.jsx)(`p`, {
...
(0, d.createRoot)(document.getElementById(`root`)).render(
	(0, p.jsx)(f.StrictMode, { children: (0, p.jsx)(x, {}) }),
);
